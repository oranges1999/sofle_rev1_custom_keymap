 ...
 * `-----------------------------------------/       /     \           /     \-----------------------------------------'
 *                  | LCTL  | LGUI  | LALT  | LOWER |  ENT  |           | SPACE | UPPER | RALT  | RGUI  | RCTL  |
 ...
 * |-------+-------+-------+-------+-------+-------|-------.           .-------|-------+-------+-------+-------+-------+-------|
 * |       |  LALT | LCTL  | LSFT  |       |  CAPS | MUTE  |           |       | PGDN  | LEFT  | DOWN  | RIGHT |  DEL  |  BSPC |
 * |-------+-------+-------+-------+-------+-------+-------|           |-------|-------+-------+-------+-------+-------+-------|
 ...
 * |-------+-------+-------+-------+-------+-------|-------.           .-------|-------+-------+-------+-------+-------+-------|
 * |       |       |CG_TOGG|       |       |       | MUTE  |           |       |       | KC_VOLD|KC_MUTE|KC_VOLU|       |       |
 * |-------+-------+-------+-------+-------+-------+-------|           |-------|-------+-------+-------+-------+-------+-------|
